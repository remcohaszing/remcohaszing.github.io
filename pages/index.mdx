  ...
  <section>
    ...
    <div className="grid">
      ...
      <section>
        ...
        - [mdxlint](https://marketplace.visualstudio.com/items?itemName=remcohaszing.mdxlint)
  ...
  <section>
    ...
    <div className="grid">
      ...
      <JobSection from={2023} icon="cuescript" name="CueScript" to="Present">
        ...
        the hood. An important requirement for them is to different text sizes. However, Monaco
        Editor did not support that. I added support for variable line heights to Monaco Editor, as
        well as support for the line wrapping calculations that come with it. This all had to be
        implemented with a big focus on performance.
      </JobSection>
